...
public class InflectorBase
{
    ...
    static HashMap<String, String>plu=new HashMap<>();
    
    public static String pluralize(String word)
    {
    	if (plu.containsKey(word)) {
    		return plu.get(word);
    	}
        String innerPlu = innerPlu(word);
        plu.put(word, innerPlu);
		return innerPlu;
    }

	public static String innerPlu(String word) {
    ...
    protected static HashMap<String, String>mm=new HashMap<>();
    ...
    public static String singularize(String word)
    {
        ...
        String innerSing = innerSing(word);
        mm.put(word, innerSing);
		return innerSing;
    }

	public static String innerSing(String word) {
		if (uncountables.contains(word))
        {
            return word;
        }
